...
## Algorithm:
1.Collect and preprocess weather dataset by handling missing values and selecting important features like temperature, humidity, and wind speed.
2.Split the dataset into training and testing sets, then train the Random Forest model using the training data.
3.Use the trained Random Forest model to predict future weather conditions on the test dataset.
4.Evaluate the prediction accuracy using performance metrics such as Accuracy Score, Precision, or Mean Squared Error (MSE).
...
## Output:
<img width="1293" height="428" alt="Screenshot 2026-05-13 081758" src="https://github.com/user-attachments/assets/73e0e779-25c6-41c4-8d9e-fff05fef3705" />
<img width="1274" height="425" alt="Screenshot 2026-05-13 084740" src="https://github.com/user-attachments/assets/b31b5121-f834-4c92-ac07-7e8a242deb05" />
<img width="1247" height="530" alt="Screenshot 2026-05-13 084807" src="https://github.com/user-attachments/assets/f88d9515-f8d1-40ca-9367-ca4f6d83bad2" />
